...
public class DbCreat {
	...
	public DbCreat() {
		...
		try {
			DbManager.db.setData("-- MySQL Script generated by MySQL Workbench\r\n"
					+ "-- Wed Mar 29 10:19:23 2023\r\n"
					...
					+ "load data local infile './datafiles/user.txt' into table 2023지방_3.user ignore 1 lines;\r\n"
					+ "load data local infile './datafiles/boarding.txt' into table 2023지방_3.boarding ignore 1 lines;\r\n"
					+ "load data local infile './datafiles/continent.txt' into table 2023지방_3.continent ignore 1 lines;\r\n"
					+ "load data local infile './datafiles/nation.txt' into table 2023지방_3.nation ignore 1 lines;\r\n"
					+ "load data local infile './datafiles/schedule.txt' into table 2023지방_3.schedule ignore 1 lines;\r\n"
					+ "load data local infile './datafiles/reservation.txt' into table 2023지방_3.reservation ignore 1 lines;\r\n"
					+ "\r\n"
					+ "drop user if exists 'user'@'localhost';\r\n"
					+ "create user 'user'@'localhost' identified by '1234';\r\n"
					+ "grant insert, update, select, delete on 2023지방_3.* to 'user'@'localhost';\r\n"
					+ "\r\n"
